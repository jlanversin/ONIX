...
def CRAM16(At,N_0):
	"""CRAM uses the Chebishev rational approximation method to compute the solution of the matricial depletion equation"""
...
def CRAM_reality_check(cell, index_dic, N):


	print('reality check called')
	passlist = cell.passlist
	leaves = cell.leaves
	fission_leaves = cell.fission_leaves
