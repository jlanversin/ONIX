...
.. fig-from-reactor-to-bomb:

.. figure:: _image/ONIX-overview2.png
   :width: 600
   :align: center
   :figclass: align-center

   ONIX has been used to model North Korea's nuclear reactor and compute past plutonium production for nuclear weapons.
...
.. admonition:: The reference scientific article for ONIX and its benchmark validation is out!
   :class: tip
...
ONIX has been developed by `Julien de Troullioud de Lanversin <https://cisac.fsi.stanford.edu/people/julien-de-troullioud-de-lanversin>`_, `Moritz Kütt <https://ifsh.de/en/staff/kuett>`_ and `Alexander Glaser <https://sgs.princeton.edu/team/alex-glaser>`_.
...
ONIX has been designed to support research in nuclear archaeology. The :strong:`NAX` module (:strong:`N`\ uclear :strong:`A`\ rchaeology  and Forensi\ :strong:`X`\ ) contains multiple Python modules and classes that can automate calculations and tasks useful to nuclear archaeology.
