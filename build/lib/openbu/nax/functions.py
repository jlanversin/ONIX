...
def list_NAX_ng_chain():
	...
	for zamid in NAX_nucl_list:
		...
		name_new_format = utils.openbu_name_to_openmc_name(name_old_format)
...
def get_ratio_evolution(chain, history_matrix):
	...
	# OpenBU always take the ratio of the higher A over lower A. However, this configuration fails sometime because
	# the lower A isotope drops to zero and the ratio presents a singulatiry
	# In this situation, OpenBU invert the ratio
